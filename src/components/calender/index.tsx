        ...
        >
          <div style={{display:"flex", justifyContent:"space-around"}}>
            <button
              ...
              style={{ color: themeClasses.chevronRightColor ,background:"rgb(255, 255, 255)", border:"0.5px dashed rgb(255, 255, 255)"}}
            >
            ...
            <button
              ...
              style={{ color: themeClasses.topBarTextColor,background:"rgb(255, 255, 255)", border:"0.5px dashed rgb(255, 255, 255)" }}
            >
            ...
            <button
              ...
              style={{ color: themeClasses.chevronLeftColor,background:"rgb(255, 255, 255)", border:"0.5px dashed rgb(255, 255, 255)" }}
            >
