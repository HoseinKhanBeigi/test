...
export const Home = () => {
  const switch1: any = React.useRef("");

  const handleChange = (e: any) => {
    const spanClients: any = document.querySelector(".spanClients");
    const spanClients2: any = document.querySelector(".spanClients2");
  ...
  return (
    <Box>
      ...
      >
        ...
        <Grid item mb={2}>
          <Typography className="title">میز کار</Typography>
        </Grid>
      </Grid>
